...
def get_stations():
    ...
    sql_query_stations= """
        SELECT DISTINCT station.address,station.bike_stands, station.name, station.position_lat,station.position_lng,station.status, avail.available_bike_stands, avail.available_bikes, avail.last_update,station.bonus,station.banking
